    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-4 mt-5">
                ...
                <img src="img/ps1.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4 mt-5">
                <div class="card" style="width: 18rem;">
                <img src="img/ps2.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
            ...
            <div class="col-md-4 mt-5">
                <div class="card" style="width: 18rem;">
                <img src="img/ps3.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/ps4.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/ps5.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/ps6.jfif" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
