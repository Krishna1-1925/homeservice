...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 fixed-top">
        <a href="index.php" class="navbar-brand"><img src="img/logo.jpg" alt="" style=" width:50px; height:50px;"> Home-<span class="color_title">Service </span></a>
         <span class="text-white">Customer's Happiness is our Main Goal</span> 
        ...
        <div class="collapse navbar-collapse" id="myMenu">
            <ul class="navbar-nav pl-5 custom-nav">
                ...
                <li class="nav-item"><a href="service.php" class="nav-link text-white">Services</a></li>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-4 mt-5">
                ...
                <img src="img/plumber-1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4 mt-5">
                <div class="card" style="width: 18rem;">
                <img src="img/plumber-2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
            ...
            <div class="col-md-4 mt-5">
                <div class="card" style="width: 18rem;">
                <img src="img/plumber-3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/plumber-4.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/plumber-5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
                ...
                <div class="card" style="width: 18rem;">
                <img src="img/plumber-6.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <a href="login.php" class="btn btn-primary">ADD</a>
