...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <?php
     ...
     if(isset($_REQUEST['id'])){
        ...
        // echo $updd;
        // die;
        $sql ="SELECT * FROM  registration WHERE r_login_id ={$_REQUEST['id']}";
     ...
     if(isset($_REQUEST['requpdate']))
     {
        ...
        // // if(($row['r_login_id'] =="") || ($row['r_name'] =="") || ($row['r_email'] ==""))
        // {
        ...
        // else{
            ...
            $sql = "UPDATE registration SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail' WHERE r_login_id ='$rid'";
    ...
    ?>
     <form action="<?php $_SELF_PHP ?>" method="POST">
        ...
        <div class="text-center">
            ...
            <a href="rquester.php" class="btn btn-secondary">Close</a>
        </div>
